...
namespace ElementaryBans\command;

use ElementaryBans\Manager;
use ElementaryBans\translation\Translation;
use ElementaryBans\util\date\Countdown;
use DateTime;
...
class TempBlockIPCommand extends Command {
    ...
    public function __construct() {
        ...
        $this->setPermission("elementarybans.command.tempblockip");
    }
